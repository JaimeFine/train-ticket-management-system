...
int StatisticsManager::totalOrders() const
{
    return m_db.countAllOrders();
}

int StatisticsManager::totalBooked() const
{
    return m_db.countOrdersByStatus(0);
}

int StatisticsManager::totalRefunded() const
{
    return m_db.countOrdersByStatus(1);
}

int StatisticsManager::totalChanged() const
{
    return m_db.countOrdersByStatus(2);
}
